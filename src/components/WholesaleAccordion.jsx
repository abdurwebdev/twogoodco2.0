...
const AccordionItem = ({ number, title, border, isOpen, toggle }) => {
  return (
    <div className={` ${border && 'border-b'} border-t w-full border-black`}>
      <button
...
const GoodPlacesAccordion = () => {
  ...
  const accordionData = [
    { number: '01', title: 'SOCIALLY SUSTAINABLE.', content: 'Description for Good Places.' },
    { number: '02', title: 'ENVIRONMENTAL SUSTAINABLE.', content: 'Description for Good Places.' },
    { number: '03', title: 'ENGAGED + EXPERIENCE TEENANTS. ', content: 'Description for Good Places.', border: true },
  ];
